...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-currency-usd"></i></span>Edit Grade</h3></div>
            <div class="card">
                <div class="card-body">
