...
{{--        <div class="col-md-6">--}}
{{--            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-plus"></i></span> Edit Project</h3></div>--}}
{{--            <div class="card">--}}
{{--                <div class="card-body">--}}
...
{{--                        <input type="text" class="form-control" id="larea" name="larea" value="{{$project->larea}}" required>--}}
{{--                    </div>--}}
{{--                    <div class="form-group">--}}
